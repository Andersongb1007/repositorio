@extends('layouts.app', ['activePage' => 'zip.create', 'titlePage' => __('Cargar registros')])
                ...
                <div class="card card-plain">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="POST" action="{{ route('zip.store') }}" class="p-4"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="mt-4 align-center mx-auto">
                                                ...
                                                <a href="{{ route('zip.index') }}" class="btn btn-danger">Cancelar</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
